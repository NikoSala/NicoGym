...
function getExerciseDatabase() {
  ...
  exerciseDatabase = [
...

    {
      ...
      descripcion:
        "Tumbado en un banco plano, sujeta las mancuernas juntas con las palmas enfrentadas. Mantén las mancuernas pegadas durante todo el recorrido mientras empujas hacia arriba y bajas controladamente.",
      consejos:
        "• Mantén las mancuernas juntas.\n• Controla el movimiento.\n• Siente la contracción del tríceps y el pecho.",
      errores:
        "• No separes las mancuernas.\n• No uses demasiado peso.\n• No bajes demasiado rápido.",
...

    {
      ...
      descripcion:
        "Sujeta una mancuerna al pecho, baja como al sentarte manteniendo la espalda recta y el pecho erguido. Baja hasta que los muslos estén paralelos al suelo.",
      consejos:
        "• Mantén la espalda recta.\n• Baja hasta que los muslos estén paralelos.\n• Empuja con los talones.",
      errores:
        "• No dejes caer las rodillas hacia dentro.\n• No pierdas el equilibrio.",
...

    {
      ...
      descripcion:
        "De pie con barra o mancuernas frente a ti, baja con espalda recta hasta sentir el estiramiento de los isquios. Sube impulsando con la cadera.",
      consejos:
...

    {
      ...
      descripcion:
        "Da un paso largo hacia adelante, baja hasta que la rodilla trasera casi toque el suelo, y sube con el talón delantero.",
      consejos:
...

    {
      ...
      descripcion:
        "Apoya un pie atrás en un banco, baja hasta que la rodilla delantera forme 90°, y sube con el talón.",
      consejos:
...

    {
      ...
      descripcion:
        "Tumbado, apoya la espalda en un banco y sube la cadera con una mancuerna sobre la pelvis.",
      consejos:
...

    {
      ...
      descripcion:
        "De pie con mancuernas a los lados, elévate con la punta de los pies y baja controladamente.",
      consejos:
...

    {
      ...
      categoria: "Aislamiento",
      urlGif:
        "https://i.pinimg.com/originals/34/5c/d9/345cd9414e1e743debd278eaddf33473.gif",
      descripcion:
        "Tumbado boca arriba con rodillas flexionadas, eleva el torso hacia las rodillas contrayendo el abdomen y baja controladamente.",
      consejos:
        "• Contrae el abdomen.\n• No tires del cuello.\n• Controla el movimiento.",
...

    {
      ...
      descripcion:
        "Tumbado boca arriba, eleva las piernas rectas hasta formar 90° y baja lentamente manteniendo el abdomen contraído.",
      consejos:
...

    {
      ...
      descripcion:
        "Tumbado, alterna codo con rodilla contraria como si pedalearas.",
      consejos:
