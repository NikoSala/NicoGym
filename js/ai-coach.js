...
const EntrenadorIA = {
  ...
  async _enviar() {
    ...
    if (!this.aceptoCompartir) {
      UI.toast("Confirma el envío del mensaje y el contexto a OpenAI", "error");
      return;
    }
